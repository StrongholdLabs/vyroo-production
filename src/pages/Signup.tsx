  ...
  if (success) {
    return (
      <div className="relative min-h-screen flex items-center justify-center bg-black px-4">
        <NeonCrystalCity cameraSpeed={2} maxSteps={60} opacity={0.2} />
        <div className="relative z-10 w-full max-w-sm text-center space-y-4">
          ...
          <Link
            to="/login"
            className="inline-block text-sm text-foreground hover:underline font-medium"
          >
            Back to sign in
          </Link>
        </div>
      ...
      <div className="relative z-10 w-full max-w-sm space-y-6">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-border text-sm font-medium text-foreground hover:bg-accent transition-colors"
          >
        ...
        <form onSubmit={handleSignup} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 rounded-xl bg-foreground text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
          >
